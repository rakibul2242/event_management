<x-app-layout>
    <div class="max-w-xl mx-auto mt-10 px-4 bg-gray-200 shadow-md py-6 rounded-md dark:bg-gray-800 dark:text-white">
        ...
        <form method="POST" action="{{ route('todos.store') }}" class="flex items-center gap-3 mb-6">
            ...
            <button class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg transition flex items-center gap-2 dark:bg-indigo-500 dark:hover:bg-indigo-600">
                ➕ <span>Add</span>
            </button>
        </form>
        ...
        <ul class="space-y-2">
            ...
            <li class="flex items-center justify-between bg-white px-3 py-2 rounded-md shadow hover:bg-gray-100 border hover:border-0 transition dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600">
